              ...
              <Reveal key={emp.id} delay={0.1 + (i % 4) * 0.1}>
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow relative z-30 -mt-8">
                    <div className={`${theme.badgeBg} border ${theme.badgeBorder} px-3 py-1 text-[10px] uppercase tracking-wider font-bold ${theme.badgeText} rounded-xl inline-block w-fit max-w-full break-words whitespace-normal mb-3 ${theme.badgeShadow} transition-all duration-300`}>
                      {emp.role}
                    </div>
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
            ...
            >
              ...
              <div className="relative -mt-8 sm:-mt-12 p-6 sm:p-8 pt-0 shrink-0 z-10">
                <div className="mb-4 inline-block max-w-full break-words whitespace-normal rounded-xl border border-[#00F0FF]/30 bg-[#00F0FF]/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-[#00F0FF] backdrop-blur-md">
